...
public class CompeticionController {
	...
	public void initController() {
		...
		view.getTablaCompeticiones().addMouseListener(new MouseAdapter() {
			@Override
	...
	public void restoreDetail() {
		...
		// tabla)
		this.lastSelectedKey = SwingUtil.selectAndGetSelectedKey(view.getTablaCompeticiones(), this.lastSelectedKey);
	...
	public void updateDetail() {
		...
		this.lastSelectedKey = SwingUtil.getSelectedKey(view.getTablaCompeticiones());
